...
Command-line interface for the [`pyanura`](https://github.com/ReVibe-Energy/pyanura) library. Installing this package puts the `anura` script on your `PATH` for interacting with ReVibe Anura sensors and transceivers.
